...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final ts METADATA_KEYS_TYPE;
    ...
    static {
        ? qae = new qae();
        METADATA_KEYS_TYPE = qae;
        wj6.q(1, qae, METADATA_KEY_TITLE, 1, METADATA_KEY_ARTIST);
        wj6.q(0, qae, METADATA_KEY_DURATION, 1, METADATA_KEY_ALBUM);
        wj6.q(1, qae, METADATA_KEY_AUTHOR, 1, METADATA_KEY_WRITER);
        wj6.q(1, qae, METADATA_KEY_COMPOSER, 1, METADATA_KEY_COMPILATION);
        wj6.q(1, qae, METADATA_KEY_DATE, 0, METADATA_KEY_YEAR);
        wj6.q(1, qae, METADATA_KEY_GENRE, 0, METADATA_KEY_TRACK_NUMBER);
        wj6.q(0, qae, METADATA_KEY_NUM_TRACKS, 0, METADATA_KEY_DISC_NUMBER);
        wj6.q(1, qae, METADATA_KEY_ALBUM_ARTIST, 2, METADATA_KEY_ART);
        wj6.q(1, qae, METADATA_KEY_ART_URI, 2, METADATA_KEY_ALBUM_ART);
        wj6.q(1, qae, METADATA_KEY_ALBUM_ART_URI, 3, METADATA_KEY_USER_RATING);
        wj6.q(3, qae, METADATA_KEY_RATING, 1, METADATA_KEY_DISPLAY_TITLE);
        wj6.q(1, qae, METADATA_KEY_DISPLAY_SUBTITLE, 1, METADATA_KEY_DISPLAY_DESCRIPTION);
        wj6.q(2, qae, METADATA_KEY_DISPLAY_ICON, 1, METADATA_KEY_DISPLAY_ICON_URI);
        wj6.q(1, qae, METADATA_KEY_MEDIA_ID, 0, METADATA_KEY_BT_FOLDER_TYPE);
        wj6.q(1, qae, METADATA_KEY_MEDIA_URI, 0, METADATA_KEY_ADVERTISEMENT);
        qae.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    }
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ts tsVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!tsVar.containsKey(str) || ((Integer) tsVar.get(str)).intValue() == 2) {
        ...
        public Builder putLong(String str, long j) {
            ts tsVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!tsVar.containsKey(str) || ((Integer) tsVar.get(str)).intValue() == 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ts tsVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!tsVar.containsKey(str) || ((Integer) tsVar.get(str)).intValue() == 3) {
        ...
        public Builder putString(String str, String str2) {
            ts tsVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!tsVar.containsKey(str) || ((Integer) tsVar.get(str)).intValue() == 1) {

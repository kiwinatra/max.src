...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newHeartRating(boolean z) {
        return new RatingCompat(1, z ? 1.0f : c44.DEFAULT_ASPECT_RATIO);
    }

    public static RatingCompat newPercentageRating(float f) {
        if (f < c44.DEFAULT_ASPECT_RATIO || f > 100.0f) {
            return null;
        }
    ...
    public static RatingCompat newThumbRating(boolean z) {
        return new RatingCompat(2, z ? 1.0f : c44.DEFAULT_ASPECT_RATIO);
    }
    ...
    public boolean isRated() {
        return this.mRatingValue >= c44.DEFAULT_ASPECT_RATIO;
    }

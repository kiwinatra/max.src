...
public final class FilePathComponents {
    ...
    public final File subPath(int i, int i2) {
        if (i >= 0 && i <= i2 && i2 <= getSize()) {
            return new File(CollectionsKt___CollectionsKt.joinToString$default(this.segments.subList(i, i2), File.separator, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 62, (Object) null));
        }
